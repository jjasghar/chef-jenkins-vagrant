...
describe 'shibboleth::default' do
  include Helpers::ShibbolethHandler

  it "has the expected ownership and permissions" do
    file("/etc/apache2/").must_exist.with(:owner, "root")
  end

  it "Check the 00hr_suite file" do
    file("/etc/apache2/sites-available/00hr_suite").must_have(:mode, "0644")
  end
